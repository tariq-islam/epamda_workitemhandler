 ...
 * 
 */
@WebServiceClient(name = "NetworkNode2", targetNamespace = "http://www.exchangenetwork.net/wsdl/node/2", wsdlLocation = "http://devngn.epacdxnode.net/ngn-enws20/services/NetworkNode2Service?WSDL")
